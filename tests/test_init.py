...
from custom_components.integration_fufopi import (
    VEDirectCoordinator,
    async_reload_entry,
    async_setup_entry,
    async_unload_entry,
)
from custom_components.integration_fufopi.const import DOMAIN
...
async def test_setup_unload_and_reload_entry(hass, bypass_get_data):
    ...
    assert type(hass.data[DOMAIN][config_entry.entry_id]) == VEDirectCoordinator
